    ...
    <section id="projects" className="section">
      <div className="container">
        ...
        <div className="grid cards">
          {projects.map(p => (
            <a key={p.id} className="card project" href={p.url} target="_blank" rel="noreferrer">
              <div className="title">{p.title}</div>
              <p className="desc">{p.description}</p>
              <div style={{marginTop:"auto", display:"flex", gap:8, alignItems:"center", color:"var(--accent)"}}>
